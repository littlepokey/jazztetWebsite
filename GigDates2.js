  ...
  axios
    ...
    .then(function(result) {
	  ...
	  for (i = 0; i < result.data.records.length; i++) {
			...
			var MyResult = GigBuilder1 + MyVenueSite + GigBuilder2 + Image + GigBuilder3 +  MyVenueName + "<br><h4>" + MyDate + "</h4>" + GigBuilder4 + MyMap + GigBuilder5 + VenueAddress + GigBuilder6;
